...
:B0:ask::
If A_EndChar = %LastChar%
	WordMenu(4,"question,inquire of,seek information from,put a question to,request,inquire")
Return
...
:B0:help::
If A_EndChar = %LastChar%
	WordMenu(5,"assist,support,relieve")
Return
...
:B0:old::
If A_EndChar = %LastChar%
	WordMenu(4,"ancient,aged,faded,former,traditional,archaic,conventional")
Return

:B0:let::
If A_EndChar = %LastChar%
	WordMenu(4,"allow,permit")
Return

:B0:keep::
If A_EndChar = %LastChar%
	WordMenu(5,"retain,preserve")
Return

:B0:look like::
If A_EndChar = %LastChar%
	WordMenu(9,"resembles,seems")
Return
...
:B0:tell::
If A_EndChar = %LastChar%
	WordMenu(5,"inform,notify,advise,explain,enlighten,instruct,insist,teach,train,direct,issue,remark,converse,speak,affirm,suppose,utter,negate,express,verbalize,voice,articulate,pronounce,deliver,convey,impart,assert,state,allege,mutter,mumble,whisper,sigh,exclaim,yell,sing,yelp,snarl,hiss,grunt,snort,roar,bellow,thunder,boom,scream,shriek,screech,squawk,whine,philosophize,stammer,stutter,lisp,drawl,jabber,protest,announce,swear,vow,content,assure,deny,dispute")
Return
...
:B0:how are you::
If A_EndChar = %LastChar%
	WordMenu(11,"No complains{!} As much as good I can be{!}")
Return

:B0:how r u::
If A_EndChar = %LastChar%
	WordMenu(12,"No complains{!} As much as good I can be{!}")
Return
...
:B0:good::
If A_EndChar = %LastChar%
	WordMenu(5,"pleasant,delightful,excellent")
Return
...
:B0:same to you::
If A_EndChar = %LastChar%
	WordMenu(11," Right back at you. Have a great day{!},Ditto{!} Have a good day{!},Likewise man/girl{!}")
Return
